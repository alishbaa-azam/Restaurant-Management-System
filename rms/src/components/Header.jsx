...
//         animate={{ y: 0, opacity: 1 }}
//         transition={{ duration: 0.6, ease: "easeOut" }}
//         className="fixed top-0 left-0 w-full z-50 bg-[#2a1a12] text-white px-4 md:px-12 py-4 md:py-6 flex items-center justify-between shadow-xl border-b border-[#5a2d0c]"
//       >
//         {/* Logo */}
//         <Link
//           to="/"
//           className="flex items-center gap-2 text-2xl md:text-3xl font-semibold text-yellow-400 tracking-wide"
//         >
//           <GiChefToque className="text-3xl md:text-4xl text-yellow-400" />
//           Foodies
//         </Link>

//         {/* Desktop Navigation + Cart + Login */}
//         <div className="hidden md:flex items-center gap-4">
//           <nav className="flex items-center gap-3 lg:gap-5 mr-4">
//             <Link
//               to="/"
//               className="flex items-center gap-2 border border-[#7a441a] px-4 lg:px-5 py-2 rounded-3xl text-yellow-300 hover:bg-[#7a441a]/40 transition duration-300 shadow-md text-sm lg:text-base"
//             >
//               <FaHome /> Home
//             </Link>
...
//             <Link
//               to="/booking"
//               className="flex items-center gap-2 border border-[#7a441a] px-4 lg:px-5 py-2 rounded-3xl text-yellow-300 hover:bg-[#7a441a]/40 transition duration-300 shadow-md text-sm lg:text-base bg-gradient-to-r from-[#f9a825]/20 to-transparent"
//             >
...
//           <Link
//             to="/cart"
//             className="flex items-center gap-1 border border-[#7a441a] px-4 py-2 rounded-3xl text-yellow-300 hover:bg-[#7a441a]/40 transition duration-300 shadow-md"
//           >
//             <FaShoppingCart className="text-lg" />
//             <span className="text-sm">{cartCount}</span>
//           </Link>
...
//           {/* Login Button */}
//           <button className="flex items-center gap-1 bg-gradient-to-b from-[#f9a825] to-[#f57c00] px-4 lg:px-5 py-2 rounded-2xl text-black font-semibold shadow-lg hover:scale-105 transition-all duration-200 text-sm lg:text-base">
//             <FaKey className="text-base" />
//             <span>Login</span>
//           </button>
//         </div>
...
//         className={`fixed top-20 left-0 w-full z-40 bg-[#2a1a12] border-b border-[#5a2d0c] shadow-2xl md:hidden ${
...
//             to="/booking"
//             onClick={() => setIsMenuOpen(false)}
//             className="flex items-center gap-3 border border-[#7a441a] px-5 py-3 rounded-2xl text-yellow-300 hover:bg-[#7a441a]/40 transition duration-300 bg-gradient-to-r from-[#f9a825]/20 to-transparent"
//           >
//             <FaCalendarAlt className="text-lg" />
//             <span className="text-lg">Book Your Table</span>
//           </Link>
...
//           <button
//             onClick={() => setIsMenuOpen(false)}
//             className="flex items-center justify-center gap-2 bg-gradient-to-b from-[#f9a825] to-[#f57c00] px-5 py-3 rounded-2xl text-black font-semibold shadow-lg hover:scale-105 transition-all duration-200 mt-4"
//           >
